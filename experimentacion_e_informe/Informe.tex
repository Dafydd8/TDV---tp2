...
Para este experimento generamos 10 csv con demanda media 500 y varianza 200, y los convertimos a instancias con distintas cotas máximas. Las cotas utilizadas fueron: 25, 20, 15, 10. Luego se corrió el modelo de circulación sobre todas las instancias y se promedió la cantidad de unidades necesarias para cada una de las cotas. El resultado se muestra en la siguiente tabla:
...
Para este experimento usamos los mismos csv del experimento 1 para la demanda baja y generamos diez nuevos con demanda normal con media 1800 y varianza 200 para la demanda alta. Al convertir los csv a instancias, lo hicimos una vez con costos de los arcos de trasnoche iguales  y una vez con un costo mayor al otro. Así, se obtienen dos configuraciones de costos, $costos_1 = (1, 1)$ y $costos_2 = (1, 2)$ para cada cronograma.  
