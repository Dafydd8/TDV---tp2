...
for cota in cotas:
    for i in range(10):
        ...
        filename = os.path.join(os.path.dirname(__file__), f'csvs/instancia{i+1}')
        ...
        instance['rs_info'] = {'capacity': 100, 'max_rs': cota}
        #pprint.pprint(instance)
        filename = os.path.join(os.path.dirname(__file__), f'cota_{cota}/instancia{i+1}')
